### Данный репозиторий содержит программу, являющуюся решением задания к уроку "Интерфейсы, наследование и полиморфизм" курса "Основы Ruby [Полная программа - 2022]" от thinknetica.com
